...
local locallv = W:AddLabel("Level")
    ...
    local Farmfast = W:AddLabel("Farm Fast : Ã¢ÂÂ")
    local Bypass = W:AddLabel("Bypass Ã¢ÂÂ")
    local Section = W:AddSection({
        Name = "World"
    })
    local WolrdSet3 = W:AddLabel("World 1 Ã¢ÂÂ ")
    local WolrdSet = W:AddLabel("Wolrd : 2 Ã¢ÂÂ")
    local WolrdSet1 = W:AddLabel("Wolrd : 3 Ã¢ÂÂ")
    local Section = W:AddSection({
        Name = "Stats Point"
    })
    ...
    local  Superhuman =             W:AddLabel("Ã¢ÂÂ : Superhuman")
    local  DeathStep =              W:AddLabel("Ã¢ÂÂ : Sharkman Karate")
    local  ElectricClaw =             W:AddLabel("Ã¢ÂÂ : Electric Claw")
    local  DragonTalon =             W:AddLabel("Ã¢ÂÂ : Dragon Talon")
    local   GodHuman =            W:AddLabel("Ã¢ÂÂ : God Human")
    local Section = W:AddSection({
        Name = "Sword Legend Check"
    })
    local   Shisui =            W:AddLabel("Ã¢ÂÂ : Shisui")
    local     Saddi =           W:AddLabel("Ã¢ÂÂ : Saddi")
    local      Wando =         W:AddLabel("Ã¢ÂÂ : Wando")
    local     TrueTripleKatana          W:AddLabel("Ã¢ÂÂ : True Triple Katana")
    local Section = W:AddSection({
        Name = "World 1 Weapon"
    })
    local   Saber  = W:AddLabel("Ã¢ÂÂ : Saber")
    local Section = W:AddSection({
        Name = "World 2 Weapon"
    })
    local       Rengoku =         W:AddLabel("Ã¢ÂÂ : Rengoku")
    local    MidnightBlade =            W:AddLabel("Ã¢ÂÂ : Midnight Blade")
    local       DragonTrident =        W:AddLabel("Ã¢ÂÂ : DragonTrident")
    local Section = W:AddSection({
        Name = "World 3 Weapon"
    })
    local     Yama =          W:AddLabel("Ã¢ÂÂ : Yama")
    local        BuddySword =        W:AddLabel("Ã¢ÂÂ : Buddy Sword")
    local       Canvander =        W:AddLabel("Ã¢ÂÂ : Canvander")
    local      TwinHooks =         W:AddLabel("Ã¢ÂÂ : Twin Hooks")
    local     SpikeyTrident =          W:AddLabel("Ã¢ÂÂ : Spikey Trident")
    local   HallowScythe =            W:AddLabel("Ã¢ÂÂ : Hallow Scythe")
    local     DarkDagger =           W:AddLabel("Ã¢ÂÂ : Dark Dagger")
    local     Tushita          W:AddLabel("Ã¢ÂÂ : Tushita")
    local Section = W:AddSection({
        Name = "Gun"
    })
    local   Kabucha =            W:AddLabel("Ã¢ÂÂ : Kabucha")
    local   AcidumRifle =             W:AddLabel("Ã¢ÂÂ : Acidum Rifle")
    local    BizarreRifle =            W:AddLabel("Ã¢ÂÂ : Bizarre Rifle")
    local Section = W:AddSection({
        Name = "Quest"
    })
    local   BartiloQuest =            W:AddLabel("Ã¢ÂÂ : Bartilo Quest")
    local   DonSwanQuest =             W:AddLabel("Ã¢ÂÂ : Don Swan Quest")
    local    KillDonSwan =           W:AddLabel("Ã¢ÂÂ : Kill Don Swan")
...
local Dark_Coat = W:AddLabel("Ã¢ÂÂ: Dark Coat")
local Ghoul_Mask = W:AddLabel("Ã¢ÂÂ: Ghoul Mask")
local Swan_Glass = W:AddLabel("Ã¢ÂÂ: Swan Glass")
local Pale_Scarf = W:AddLabel("Ã¢ÂÂ: Pale Scarf")
local Valkyrie_Helm = W:AddLabel("Ã¢ÂÂ: Valkyrie Helm")
        ...
        pcall(function()
            for i,v in pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")) do
                if v.Name == "Saber" then
                    Dark_Coat:Set("Ã¢ÂÂ: Dark Coat")
                end
                if v.Name == "Ghoul Mask" then
                    Ghoul_Mask:Set("Ã¢ÂÂ: Ghoul Mask")
                end
                if v.Name == "Swan Glasses" then
                    Swan_Glass:Set("Ã¢ÂÂ: Swan Glass")
                end
                if v.Name == "Pale Scarf" then
                    Pale_Scarf:Set("Ã¢ÂÂ: Pale Scarf")
                end
                if v.Name == "Valkyrie Helmet" then
                    Valkyrie_Helm:Set("Ã¢ÂÂ: Valkyrie Helmet")
                end
            end
        end)
    end
...
M:AddParagraph("Kaitun/Cantay","Kaitun bÃ¡ÂºÂ£n nÃÂ y ÃÂell khÃÂ¡c gÃÂ¬ bÃ¡ÂºÂ£n kia.")

M:AddToggle({
    Name = "Kaitun[Ko cÃÂ³ kill players]",
    Default = false,
    Flag = "Kaitun",
    Save = true,
    Callback = function(Value)
...
M:AddParagraph("Auto Farm Boss :","ChÃ¡Â»Â Update thÃÂ´i ae!!!")
    ...
    while wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert") or game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert") or game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert") or game:GetService("Workspace").Enemies:FindFirstChild("Saber Expert") or game:GetService("Workspace").Enemies:FindFirstChild("Saber Expert") or game:GetService("Workspace").Enemies:FindFirstChild("Saber Expert") then
                SaberBoss:Set("Boss Saber : Ã¢ÂÂ Spawn")
            else
                SaberBoss:Set("Boss Saber : Ã¢ÂÂ Not Spawn")
            end
        end)
    end
end)
    ...
    while wait() do
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("Thunder God") or game:GetService("ReplicatedStorage"):FindFirstChild("Thunder God") or game:GetService("ReplicatedStorage"):FindFirstChild("Thunder God") or game:GetService("Workspace").Enemies:FindFirstChild("Thunder God") or game:GetService("Workspace").Enemies:FindFirstChild("Thunder God") or game:GetService("Workspace").Enemies:FindFirstChild("Thunder God") then
                PoleBoss:Set("Boss Thunder : Ã¢ÂÂ Spawn")
            else
                PoleBoss:Set("Boss Thunder : Ã¢ÂÂ Not Spawn")
            end
        end)
    end
end)
...
IQ:AddToggle({
    ...
    Callback = function(Value)
        ...
        IQ:AddLabel("Cho thÃ¡ÂºÂ±ng nÃÂ o ÃÂell hiÃ¡Â»Âu thÃÂ¬ ÃÂÃÂ¢y lÃÂ  tÃ¡Â»Â± ÃÂÃ¡Â»Âng ÃÂÃÂ¡nh hÃÂ¬nh nÃ¡Â»Âm")
    ...
    Callback = function(Value)
        ...
        if _G.TeleportIsland == true then
            repeat wait()
                ...
                elseif _G.SelectIsland == "Candy Island NewÃ¢ÂÂ" then
...
local Elite_Hunter_Status = SV:AddLabel("Only Third Sea")
            ...
            while wait() do
                pcall(function()
                    if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                        Elite_Hunter_Status:Set("Elite : Ã¢ÂÂ Spawn")	
                    else
                        Elite_Hunter_Status:Set("Elite : Ã¢ÂÂ not Spawn")	
                    end
                end)
            end
        end)
      ...
      if World3 then
        ...
        Mirragecheck:Set('Mirrage: Ã¢ÂÂ')
        else
          Mirragecheck:Set('Mirrage: Ã¢ÂÂ ' )end
                end
            end)
    end)
end
    ...
    while wait() do
        pcall(function()
            ...
            elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
                ...
                MobKilled:Set("Dough King V1 : Ã¢ÂÂ")
            end
        end)
    end
end)
...
function DropFruit()
    pcall(function()
        ...
        game.Players.LocalPlayer.PlayerGui.Main.FruitInventory.Visible = true -- Ã Â¹ÂÃ Â¸ÂÃ Â¸Â´Ã Â¸ÂÃ Â¹ÂÃ Â¸Â§Ã Â¹ÂÃ Â¸ÂÃ Â¸Â¶Ã Â¸ÂÃ Â¸ÂÃ Â¸Â°Ã Â¹ÂÃ Â¸ÂÃ Â¹ÂÃ Â¸ÂÃ Â¹ÂÃ Â¸ÂÃ Â¹Â
    ...
    while wait(.1) do
        if LockLevel then
            if game.Players.localPlayer.Data.Level.Value >= LockLevelValue then
                game.Players.localPlayer:Kick("Lock Level : Done[ÃÂÃÂºng Level mÃÂ y nÃÂ³i rÃ¡Â»Âi!]")
            end
        end
    end
end)
    ...
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                ...
                OrionLib:MakeNotification({
                    Name = "Sla Hub(Noitification)",
                    Content = "[VN] : LÃÂ m ÃÂ¡n hÃ¡Â»Â§y nhiÃ¡Â»Âm vÃ¡Â»Â¥ farrm level(nÃ¡ÂºÂ¿u cÃÂ³)",
                    Image = "rbxassetid://119980140458596",
                    Time = 9
                })
            end
